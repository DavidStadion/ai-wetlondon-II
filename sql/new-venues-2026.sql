...
('Wake The Tiger', '{entertainment,galleries}', 'west', 'dry', 0, 20, 'From £20',
 'An 80,000 sq ft ''amazement park'' at Westfield, full of psychedelic rooms you wander through rather than look at. Not a gallery, not a ride, somewhere in between.', 4.6, true),
...
('Dennis Severs'' House', '{historic,museums}', 'east', 'dry', 5, 20, 'From £20',
 'A Spitalfields house frozen mid-18th-century, explored in silence by candlelight. Theatre more than museum, and you leave slightly haunted.', 4.6, false),
...
('Horniman Museum', '{museums,family}', 'south', 'slightly', 20, 0, 'FREE',
 'Free museum of the world in Forest Hill, with an overstuffed walrus, an aquarium, and a natural history gallery unchanged in a century.', 4.7, false);
